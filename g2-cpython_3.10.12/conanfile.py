...
#       endif /* Py_BUILD_CORE */
    ...
    def package(self):
        ...
        if self.settings.os != "Windows":
            ...
            with tools.chdir(os.path.join(self.package_folder, "bin")):
                ...
                python_shebang = "#!/usr/bin/env python3.10\n"
                for name in ["2to3-3.10", "idle3.10", "pydoc3.10", "pip3", "pip3.10", "wheel"]:
    ...
    def package_info(self):
        ...
        if self.settings.os != "Windows":
            ...
            name = "python%s%s" % (version_suffix, debug_suffix)
