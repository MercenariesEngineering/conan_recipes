...
#conan upload Alembic/1.7.12@mercseng/v1                                         -r mercseng --all --confirm
...
#conan upload boost/1.73.0@mercseng/v6                                           -r mercenaries --all --confirm
...
#conan upload cmake/3.28.1@mercseng/v0                                           -r mercseng --all --confirm
...
#conan upload libalsa/1.2.2@mercseng/v1                                          -r mercenaries --all --confirm
...
#conan upload llvm/13.0.1@mercseng/v0                                            -r mercenaries --all --confirm
...
#conan upload OpenImageDenoise/1.4.2@mercseng/v0                                 -r mercseng --all --confirm
...
conan upload USD/23.11-rumba@mercseng/v1                                        -r mercenaries --all --confirm
