...
conan upload Alembic/1.7.12@mercseng/v0                                         -r mercseng --all --confirm
...
conan upload bzip2/1.0.6@mercseng/v0                                            -r mercseng --all --confirm
...
conan upload embree/3.9.0@mercseng/v0                                           -r mercseng --all --confirm
...
conan upload glfw/3.3@mercseng/v0                                               -r mercseng --all --confirm
...
conan upload libclang/7.0@mercseng/v0                                           -r mercseng --all --confirm
...
conan upload OpenEXR/2.4.0@mercseng/v0                                          -r mercseng --all --confirm
...
conan upload OpenImageDenoise/1.0.0@mercseng/v0                                 -r mercseng --all --confirm
...
conan upload tbb/2020.02@mercseng/v0                                            -r mercseng --all --confirm
conan upload USD/20.05@mercseng/v0                                              -r mercseng --all --confirm
