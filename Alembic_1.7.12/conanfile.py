...
class AlembicConan(ConanFile):
    ...
    def source(self):
        ...
        tools.replace_in_file("%s/CMakeLists.txt" % self._source_subfolder, """-Wno-unused-parameter""", """-Wno-unused-parameter -Wno-unused-function -Wno-implicit-fallthrough -Wno-deprecated-copy""")
