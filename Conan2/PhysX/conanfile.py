...
class PhysXConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.cache_variables["PX_ROOT_LIB_DIR"] = "lib"
        tc.cache_variables["PX_ROOT_BIN_DIR"] = "bin"
        tc.cache_variables["PX_OUTPUT_LIB_DIR"] = self.package_folder.replace("\\", "/")
        tc.cache_variables["PX_OUTPUT_BIN_DIR"] = self.package_folder.replace("\\", "/")
        ...
        if self.settings.os == "Linux":
            tc.cache_variables["GPU_LIB_COPIED"] = True
