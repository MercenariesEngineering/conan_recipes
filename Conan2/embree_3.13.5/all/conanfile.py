...
class EmbreeConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.variables["EMBREE_CURVE_SELF_INTERSECTION_AVOIDANCE_FACTOR"] = "0"
    ...
    def _patch_sources(self):
        ...
        # oneTBB 2020.x is fine
        replace_in_file(self, 
            os.path.join(self.source_folder, "common", "tasking", "CMakeLists.txt"),
    ...
    def package(self):
        ...
        # Mercenaries: Guerilla needs common & kernel includes, and simd libs
    ...
    def package_info(self):
        ...
        # Mercenaries: We need these interal defines
        if self.options.with_tbb:
            self.cpp_info.defines.append("TASKING_TBB")
        else:
            self.cpp_info.defines.append("TASKING_INTERNAL")
        if not self.options.shared:
            self.cpp_info.defines.append("EMBREE_STATIC_LIB")

        self.cpp_info.libs = ["embree3"]
        # Mercenaries: we need to link against internal simd libs
